...
public class C02_ReadExcel {
    ...
    public void test01() throws IOException {
        ...
        String dosyaYolu = "C:\\Users\\esra_\\OneDrive\\Masaüstü\\GitHubTeam108\\seleniumTeam108\\src\\test\\java\\Day09_excel_screenshot_jsExecutor\\ulkeler.xlsx";
        ...
        System.out.println("Sayfa2 fiziki kullanilan satir sayisi : " +
                workbook.getSheet("Sayfa2").getLastRowNum());
        ...
        for (int i = 1; i < sonSatirIndex; i++) { // basligi almamak icin 1 den baslatin
